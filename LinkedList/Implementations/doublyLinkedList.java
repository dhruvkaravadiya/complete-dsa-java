...
class LinkedList {
    ...
    public void insertAtEnd(int data){
        ...
        if(head==null){
            ...
            tail.next = newNode;
            // 2. set newNode's prev pointer to the tail node as doubly linked list can me traversed both ways
            newNode.prev = tail;
    ...
    public void insertAtNth(int data,int pos){
        ...
        //then store the next element of the node , so we insert a node in middle of them
    ...
    public void deleteAtEnd(){
        ...
        if(tail == null){
            ...
            //as it will update the last element's next link to null,making it the last element
            tail.next = null;
        }
        size--;
    }
