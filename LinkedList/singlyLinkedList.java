...
class SinglyLinkedListImplemented {
    ...
    public void deleteNthNode(int deleteIndex) {
        ...
        if (head == null) {
            ...
            // Remove the link to the node to be deleted by connecting the previous node to
            // the one after
    ...
    public Node searchByValue(int data) {
        ...
        if (head == null) {
            ...
            while (temp.data != data) {
                temp = temp.next;
                index++;
                // If we reach the end of the linked list without finding the data value, print
